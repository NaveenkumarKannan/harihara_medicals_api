...
class Invoice{
    ...
    private $user  = 'u401320649_root';
    private $password   = 'harihara_medicals';
    private $database  = 'u401320649_social_grub';   
	...
	public function getInvoiceList(){
		$sqlQuery = "
			...
			WHERE user_id = '0'"; // session user id 
		return  $this->getData($sqlQuery);
	}	
	public function getInvoice($invoiceId){
		$sqlQuery = "
			SELECT * FROM ".$this->invoiceOrderTable." 
			WHERE user_id = '0' AND order_id = '$invoiceId'"; // session user id
		$result = mysqli_query($this->dbConnect, $sqlQuery);	
