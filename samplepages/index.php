                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                <div>
                                    <strong><span class=" label label-danger">HariHara</span></strong>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong><span class=" label label-info">Harihara</span></strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                                </div>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong><span class=" label label-success">Harihara</span></strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                                </div>
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                     ...
                     <li>
                        <a href="stock.html"><i class="fa fa-flask fa-fw"></i>Stock</a>
                    </li>
                    <li>
                        <a href="payment.html"><i class="fa fa-table fa-fw"></i>Payments</a>
                    </li>
                    <li>
                        <a href="appointment.html"><i class="fa fa-edit fa-fw"></i>Appointments</a>
                    </li>
                    <li>
                        <a href="panels_well.html"><i class="fa fa-edit fa-fw"></i>Panels and Well</a>
                    </li>
                    <li>
