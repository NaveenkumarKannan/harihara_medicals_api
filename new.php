                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div>Hari <stron>Hara</strong></div>
...
<input type="mail" name="Email_id" placeholder="Mail id" required/><br><br>
<center><input type="button" value="ADD" ></center>
