    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">CUSTOMER PRESCRIPTION</h1>
...
$conn = mysqli_connect("localhost","u401320649_root","harihara_medicals","u401320649_social_grub");
    ...
    $sql = "SELECT  patient_name,tablet_name,dosage,before_meals,after_meals,morning,afternoon,night from cust_prescription";
    $result =  $conn ->query($sql);
     if( $result->num_rows > 0 ){
        // if($result){
        while ($row = $result ->fetch_assoc()) {
            echo "<tr><td>".$row["patient_name"]."</td>"."<td>".$row["tablet_name"]."</td>"."<td>".$row["dosage"]."</td>"."<td>".$row["before_meals"]."</td>"."<td>".$row["after_meals"]."</td>"."<td>".$row["morning"]."</td>"."<td>".$row["afternoon"]."</td>"."<td>".$row["night"]."</td>";
