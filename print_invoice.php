...
$output = '';
$output .= '<table width="100%" border="1" cellpadding="6" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><img src="assets/img/new.png" alt="" width="22" height="20"/><b> HARIHARA MEDICALS </b></td>
	</tr>
	<tr>
	<td colspan="2">
