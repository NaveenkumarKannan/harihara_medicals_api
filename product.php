                            ...
                            $result =  $conn ->query($sql);
                             if( $result->num_rows > 0 ){
                                while ($row = $result ->fetch_assoc()) {
                                   ...
                                   echo "<tr><td>".$row["id"]."</td>"."<td>".$row["productname"]."</td>"."<td>".$row["category"]."</td>"."<td>".$row["company"]."</td>"."<td>".$row["price"]."</td>"."<td>".$row["sku"]."</td>"."<td>".$row["expirydate"]."</td>"."<td>".$row["stock"]."</td>"."<td>".$row["image"]."</td>";
                                ...
                                echo '<td><button type="button" class="btn btn-outline btn-primary data-toggle="modal" data-target="#myedit" ><b><font color="#fff"><a href="e.php?id=' . $row['id'] . '">Edit</a></b></button>';
                                ...
                                echo '<button type="butoon" class="btn btn-outline btn-danger ><b><font color="#fff"><a href="d.php?id=' . $row['id'] . '">Delete</a></font></b></button></td>';
                                   echo '</tr>';
