    ...
    <div class="modal-content">
      ...
      <div class="panel-body">
                          <div class="row">
                           ...
                           </textarea>--><input class="form-control" type="text" size="" style="width: 556px; height: 86px;" name=comment>
...
if(isset($_POST['add'])){
  ...
  /*if($name =='' || $email == '' || $password == ''){
      ...
      $query = "INSERT into news_feed VALUES ('','$comment','','','')";
     // $query="Insert into news_feed values('','text','','','')";
